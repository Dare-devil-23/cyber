...
const state = {
  ...
  paragraphs: [
    ...
    { offset: 7, factor: 1.05, header: "The Factory", image:process.env.PUBLIC_URL+ "/scroll/photo-1548191265-cc70d3d45ba1.jpeg", aspect: 1.77, text: "Education and enlightenment." }
  ],
  stripes: [
