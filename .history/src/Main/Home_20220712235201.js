    ...
    <div>
      {!loading && (
        <div >
          ...
          <GlobalStyles />
          <Parallax pages={3}>
            <ParallaxLayer offset={1} factor={1} className="jumbotron scrollanim">
            ...
            <ParallaxLayer offset={2} factor={1} className="cards scrollanim">
            ...
            <ParallaxLayer offset={3}  factor={1} className="scrollanim">
              <AboutNew />
            </ParallaxLayer>
          </Parallax>
          <Footer />
