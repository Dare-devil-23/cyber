  ...
  return (
    <>
      <Block factor={1} offset={0}>
        ...
        <Block factor={1.0}>
          <Html position={[-w / 3.2, -w * 0.08 + 0.25, -1]}>It was the year 2076.{mobile ? <br /> : " "}The substance had arrived.</Html>
        </Block>
      </Block>
...
function HomeTest() {
  ...
  return (
    <>
      <Canvas className="canvas" concurrent="true" pixelratio={1} orthographic camera={{ zoom: state.zoom, position: [0, 0, 500] }}>
